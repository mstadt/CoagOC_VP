...
scatter(samplesNoOC, samplesLev, ...
            'MarkerFaceColor', c_lev,...
            'MarkerEdgeColor', c_lev,...
            'MarkerFaceAlpha', alpha1, ...
            'MarkerEdgeAlpha', alpha1)
scatter(samplesNoOC, samplesDsg, ...
            'MarkerFaceColor', c_dsg,...
            'MarkerEdgeColor', c_dsg,...
            'MarkerFaceAlpha', alpha2, ...
            'MarkerEdgeAlpha', alpha2)
